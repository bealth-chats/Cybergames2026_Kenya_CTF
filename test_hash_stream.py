...
for sign in [1, -1]:
    ...
    for hash_algo in [hashlib.md5, hashlib.sha1, hashlib.sha256]:
        ...
        for W in [W0, W1, W2, W3]:
            ...
            # or hash y
            pass
        # I'll just test if the first 8 bytes XOR to SK-CERT{
        # wait, if hash is used, it wouldn't start with 76126ce276dc5c53!
        # Because hash(x0) doesn't start with 76126ce276dc5c53!
        # BUT the user SAID x0 = 7612...
        # So x0 IS the keystream block!
